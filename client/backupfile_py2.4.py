...
#class mysqlcon:
    #def __init__(self,host=parserconf('Database','host'),port=parserconf('Database','port'),
                 #user = parserconf('Database','user'),password = parserconf('Database','password'),
                 #databasename = parserconf('Database','database')):
        #self.host = host
        #self.port = port
        #self.user = user
